...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/nerdsupremacist/GraphQL.git", from: "0.12.1-beta.5"),
        .package(url: "https://github.com/nerdsupremacist/Runtime.git", from: "2.1.2-beta.10"),
